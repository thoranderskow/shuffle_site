A project created with ReactJs and Firebase to simulate shuffling a hand of five cards, and checking to see if that exact hand has been shuffled before on the website.
